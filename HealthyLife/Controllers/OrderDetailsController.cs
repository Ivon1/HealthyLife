...
namespace HealthyLife.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.OrderDetails.Include(o => o.Course).Include(o => o.Order);
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,CourseId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OrderId,CourseId")] OrderDetail orderDetail)
        {
